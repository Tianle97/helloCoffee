...
public class LoadDatabase {
    ...
    @Bean
    CommandLineRunner initOrders(OrderRepository orderRepository, CoffeeRepository coffeeRepository) {
        return args -> {
            Order order = new Order("user", "Pending", "Cash", 3.5);

            Coffee co1 = new Coffee("Cappuccino", "Cappuccino.jpg", "Large", "Regular", "Almond milk",
                    "Chocolate powder");
